...
<ul class="menu">
  ...
  <div align="center" style="color:#02A63D; margin-top:50px;"> <h2> Reserve Cart </h2> </div>
  ...
  <div class="event-block">
    ...
    <label for="Select1"><p style="text-align:center">Select</label>
    <select class="form-control" id="exampleSelect1">
      ...
      <option>10-1</option>
                ...
                <td><a href="javascript:window.open('MapServlet?foodName=<%= food.getFoodStoreId() %>', 'yourWindowName', 'width=800,height=750');"> <img src="images/pin.png"/> </a> </td>
              </tr>
               <%}%>
            </tbody>
          </table>
  ...
  <div class="section-padding"></div>
  <div align="center"><span class="section-header-block"><a href="Successful.jsp" title="View All">Reserve</a></span></div>
  <div class="section-padding"></div>
</div>
<!-- Event Section /- --> 
<!-- Footer Main -->

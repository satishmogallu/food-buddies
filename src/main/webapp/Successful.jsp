...
<ul class="menu">
  ...
  <!-- panel -->
  <div align="center" style="color:#02A63D; margin-top:50px;"> </div>
    <div class="section-padding"></div>
  <div class="panel panel-success">
    <div class="panel-heading"><h2> Acknowledgement </h2> </div>
  ...
  <table class="table">
      <thead>
        <tr>
          ...
          <th>Qty.</th>
          <th>Type</th>
          <th style="text-align:center">Pick-up slot</th>
        </tr>
      </thead>
      <tbody>
	  					<%
        ...
        <tr>
          ...
          <td><p>Cold</p></td>
          <td><div class="event-meta"><span><em aria-hidden="true" class="fa fa-clock-o"></em>9:00 Am - 12:00 Pm</span></div></td>
  ...
  <div class="event-block" >
    <div align="center" style="color:#ACACAC; margin-top:50px;" class="alert alert-success" role="alert">
      <h3>&ldquo; Your  order summary with pick-up reservation details has been sent to your registered  e-mail ID : <%= session.getAttribute("email")%> and phone number : <%= session.getAttribute("Phone Number")%>&ldquo;.</h3>
    </div>
  </div>
  <div class="section-padding"></div>
  <div align="center"><span class="section-header-block"><a href="#" title="View All">Save</a></span></div>
  <div class="section-padding"></div>
</div>
<!-- Event Section /- --> 
<!-- Footer Main -->
<footer class="footer-main footer2 container-fluid no-padding"> 
  ...
  <div class="container"> <!-- Footer Bottom -->
    <div class="footer-bottom col-md-12 col-sm-12 no-padding">
      <div class="copyright no-padding"> <span>©1990-2016 Peapod, LLC All Rights Reserved. 1-800-5-PEAPOD (1-800-573-2763)
<br>All trademarks and copyrights held by respective owners.</span> </div>
      <nav class="navbar ow-navigation">
        <div class="navbar-header">
